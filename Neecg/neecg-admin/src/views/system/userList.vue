<template>
    <div class="neecg-box">
                ...
                <a-row :gutter="[16, 24]">
                    <a-col class="gutter-row" :span="6">
                        <a-form-item label="用户名称">
                            <a-input style="width: 100%;" v-model:value="data.queryParam.user_name"
                                placeholder="用户名称" />
                        </a-form-item>
                    </a-col>
                    <a-col class="gutter-row" :span="6">
                    ...
                    <a-col class="gutter-row" :span="6">
                        <a-form-item label="用户角色">
                            <a-input style="width: 100%;" v-model:value="data.queryParam.user_role"
                                placeholder="用户角色" />
                        </a-form-item>
                    </a-col>
                </a-row>
        ...
        <user-modal ref="modalForm" @submitSuccess="handle.submitSuccess"></user-modal>
    </div>
</template>

<script setup>
import { ref, reactive, onMounted } from 'vue';
import userModal from './model/userModal.vue'
...
const httpUrl = reactive({
    list:'SystmeUser/list',
    delete:'SystmeUser/delete'
})
onMounted(() => {
